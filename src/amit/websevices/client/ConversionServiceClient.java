...
public class ConversionServiceClient {
	static final String REST_URI = "http://localhost:7070/WebServiceExample";
	...
	public static void main(String[] args) {
		...
		WebResource addService = service.path("").path(INCH_TO_FEET + inch);
		...
		WebResource subService = service.path("").path(FEET_TO_INCH + feet);
